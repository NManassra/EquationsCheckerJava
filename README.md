# Java Equation Syntax Checker

> Historical coursework · Birzeit University Computer Engineering portfolio

A focused Java exercise for validating whether mathematical equations follow the expected syntax.
...
`checkEquation.java` drives validation with the `Equation` model.

## Getting started

Compile both Java files and run the checker class.
